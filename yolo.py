...
def draw_labels(boxes, confs, colors, class_ids, classes, img): 
    global printed  # Use the global variable

    fire_detected = False  # Initialize to False
    ...
    for i in range(len(boxes)):
        if i in indexes:
            ...
            if label.lower() == 'fire' and confidence > 0.996:  # Check if detected object is fire with more than 90% accuracy
                fire_detected = True
    ...
    # Print "Fire detected" only if fire is detected with more than 90% accuracy and not already printed
    if fire_detected and not printed:
        print("Fire detected")
        printed = True  # Update the global variable
        play_alarm_sound_function()  # Call your play_alarm_sound_function here
        #send_email()  # Call your send_email function here
